...
export class CarAudio {
  ...
  update(dt,s){
    ...
    const skid=speed>1?Math.min(1,s.rearLocked?1:Math.max(0,(s.slip-4)/24)):0;
    this.tyres.gain.setTargetAtTime(document.hidden?0:skid*.42,t,.04);this.squealFilter.frequency.setTargetAtTime(1300+skid*900,t,.1);this.tone.frequency.setTargetAtTime(900+skid*420,t,.07);
  }
}
