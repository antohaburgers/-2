...
const BUILD='v10-20260925-1';
const PREFIX='drift-park:'+new URL(self.registration.scope).pathname+':';
const CACHE=PREFIX+BUILD;
const FILES=['./','index.html','game.js','physics.js','camera.js','touge.js','rapier.js','input.js','particles.js','audio.js','map.js','pwa.js','style.css','manifest.webmanifest','icon-192.png','icon-512.png'];
