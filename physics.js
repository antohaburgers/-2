...
export class CarPhysics {
  ...
  step(dt) {
    ...
    const maxSteer=c.steeringAngle*(1-c.highSpeedSteeringReduction*speedNorm)+slowTurn*.25;
    ...
    const yawTarget=geometricYaw*(1+this.driftAmount*(.22+slowTurn*.50))*(this.rearLocked?1.22:1)+alignment;
